...
function SpriteSheet:new(spriteName, assetsDirectory, jsonDecoder)
    local this = {atlas = nil, quads = {}, origin = nil, filename = (assetsDirectory or "") .. spriteName}
    local file = love.filesystem.read(this.filename .. ".json")
    ...
    if file and jsonDecoder then
        ...
        atlasInfo = require(this.filename:gsub("/", "%."))
    end
